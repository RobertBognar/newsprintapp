...
import sprintapp.security.TokenUtils;
import sprintapp.service.UserService;
import sprintapp.support.UserToUserDto;
import sprintapp.web.dto.LoginDTO;
import sprintapp.web.dto.UserDTO;
import sprintapp.web.dto.UserPasswordChangeDTO;
import sprintapp.web.dto.UserRegistrationDTO;
...
public class ApiUserController {
	...
	@CrossOrigin(origins = "http://localhost:8081", maxAge = 3600) // moze i bez http:// dela
	@GetMapping("/{id}")
